...
function print_manga2(MangaData,location){
    ...
    for(let i = 0; i < MangaData.data.length-1; i = i+3){
            ...
            <div class="flex">
                <div class="sections"> 
                        <img onclick = "getMangaInfo(${MangaData.data[i].mal_id})" src="${MangaData.data[i].images.jpg.image_url}" style="display:inline-block;"/>
                        <h5 >#${MangaData.data[i].rank}  ${MangaData.data[i].title}</h5>
                        <h5>Rating: ${MangaData.data[i].score}/10  ${sym_rating}</h5>
                </div>
                <div class="sections"> 
                        <img onclick = "getMangaInfo(${MangaData.data[i+1].mal_id})" src="${MangaData.data[i+1].images.jpg.image_url}" style="display:inline-block;"/>
                        <h5 >#${MangaData.data[i+1].rank}  ${MangaData.data[i+1].title}</h5>
                        <h5>Rating: ${MangaData.data[i+1].score}/10  ${sym_rating}</h5>
                </div>
                <div class="sections"> 
                        <img onclick = "getMangaInfo(${MangaData.data[i+2].mal_id})" src="${MangaData.data[i+2].images.jpg.image_url}" style="display:inline-block;"/>
